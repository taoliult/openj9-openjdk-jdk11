...
public final class SunPKCS11 extends AuthProvider {
    ...
    SunPKCS11(Config c) {
        ...
        try {
            ...
            // When security restrict mode is enabled, configure p11 object to
            // security restrict mode and pass the parent object so it can callback.
            if (SecurityRestrictConfigurator.enableSecurityRestrict()) {
                if (debug != null) {
                    System.out.println("Security restrict mode in SunPKCS11");
                }
