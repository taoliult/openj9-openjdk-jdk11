...
abstract class HmacCore extends MacSpi implements Cloneable {
    ...
    HmacCore(String digestAlgo, int bl) throws NoSuchAlgorithmException {
        ...
        System.out.println("TAO DEBUG - HmacCore - 1");
        if (!(md instanceof Cloneable) && !RestrictedSecurityConfigurator.isFIPSSupportPKCS12()) {
            System.out.println("TAO DEBUG - HmacCore - 2: " + md.toString());
