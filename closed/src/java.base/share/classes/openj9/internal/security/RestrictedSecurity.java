...
public final class RestrictedSecurity {
    ...
    /**
     * Restricted security mode secure random provider
     *
    ...
    /**
     * Restricted security mode secure random algorithm
     *
    ...
    public static boolean isProviderAllowed(Class<?> providerClazz) {
        if (securityEnabled) {
            return restricts.isRestrictedProviderAllowed(providerClazz);
        }
        return true;
    }
    ...
    public static boolean configure(Properties props) {
        ...
        try {
            if (shouldEnableSecurity) {
                ...
                setProviders(props, restricts.providers);
    ...
    private static void setProperties(Properties props, RestrictedSecurityProperties properties) {
        ...
        propsMapping.put("jdk.tls.disabledNamedCurves", properties.jdkTlsDisabledNamedCurves);
        propsMapping.put("jdk.tls.disabledAlgorithms", properties.jdkTlsDisabledAlgorithms);
        propsMapping.put("jdk.tls.ephemeralDHKeySize", properties.jdkTlsDphemeralDHKeySize);
        propsMapping.put("jdk.tls.legacyAlgorithms", properties.jdkTlsLegacyAlgorithms);
        propsMapping.put("jdk.certpath.disabledAlgorithms", properties.jdkCertpathDisabledAlgorithms);
        propsMapping.put("jdk.security.legacyAlgorithm", properties.jdkSecurityLegacyAlgorithm);
        ...
        String keyStore = properties.keyStore;
    ...
    /**
     * Nested class for the properties of restricted security
     */
    private static final class RestrictedSecurityProperties {
        ...
        private void initProviders() {
            ...
            for (int pNum = 1;; ++pNum) {
                ...
                if (debug != null) {
                    debug.println(
                            "Loaded restricted security provider: " + providers.get(pNum - 1) + " with short name: "
         ...
         * @return true if the Service is allowed
         */
        private boolean isRestrictedServiceAllowed(Service service) {
         ...
         * @return true if the provider is allowed
         */
        private boolean isRestrictedProviderAllowed(String providerName) {
         ...
         * @return true if the provider is allowed
         */
        private boolean isRestrictedProviderAllowed(Class<?> providerClazz) {
            ...
            return isRestrictedProviderAllowed(providerName);
        }
